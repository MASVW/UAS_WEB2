                ...
                <div class="mx-auto shadow-lg rounded-lg px-20 py-10 w-full bg-white">
                    ...
                    <div class="mt-2 sm:mx-auto sm:w-full ">
                            ...
                            <div class="flex w-full border-2 h-full rounded-lg p-8 items-center">
                                <div class="flex-1">
                                    <div class="mb-4">
                                        <h4 class="text-xl font-semibold text-sky-500">Hirework Job Festival 2024</h4>
                                    </div>
                                    <div>
                                        <p class="">
                                            Posisi: Mahasiswa
                            ...
                            <div class="flex w-full border-2 h-full rounded-lg p-8 mt-4 flex items-center">
                                <div class="flex-1">
                                    <div class="mb-4">
                                        <h4 class="text-xl font-semibold text-sky-500">Hirework Job Festival 2024</h4>
                                    </div>
                            ...
                            <div class="flex justify-end py-8">
                                <div class="">
                                    <button type="submit" class="flex w-full justify-center rounded-md border border-sky-500 text-sky-500 px-3 py-1.5 text-sm font-semibold leading-6  shadow-sm hover:bg-sky-500 hover:text-white active:bg-sky-700 transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-700">Kembali</button>
                                </div>
                                <div class="ps-4">
                                    <button type="submit" class="flex  w-full justify-center rounded-md bg-sky-500 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-sky-600 active:bg-sky-700 transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-700">Isi Formulir</button>
                                </div>
                            </div>
                    </div>
                </div>
                ...
                <div class="mx-auto shadow-lg rounded-lg px-20 py-10 w-full bg-white">
                    ...
                    <div class="mt-2 sm:mx-auto sm:w-full ">
                            ...
                            <div class="flex justify-end py-8">
                                ...
                                <div class="ps-4">
                                    <button type="submit" class="flex  w-full justify-center rounded-md bg-sky-500 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-sky-600 active:bg-sky-700 transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-700">Lanjut</button>
                                </div>
                            </div>
                    </div>
                </div>
