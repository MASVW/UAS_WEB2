<div>
    <div class="relative isolate px-6 pt-14 lg:px-8 z-20">
        <div class="mx-auto max-w-7xl pt-48 pb-20 sm:pt-48 sm:pb-20 lg:pt-56 lg:pb-20">
                ...
                <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form class="space-y-6" method="post" action="/login">
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input id="password" name="password" type="password" autocomplete="current-password" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-400 sm:text-sm sm:leading-6">
                            </div>
                            @error('password')
                                <label class="text-xs text-red-600 font-semibold">{{$message}}</label>
                            @enderror 
