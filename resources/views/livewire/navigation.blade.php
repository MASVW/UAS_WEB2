      ...
      <div class="2xl:text-xl lg:text-lg hidden lg:flex lg:flex-1 lg:justify-end">
        @auth
              <div x-data="{ isOpen: true }" class="relative inline-block">
                  ...
                  <button @click="isOpen = !isOpen" class="font-semibold capitalize relative z-10 flex items-center p-2 text-lg text-gray-900 bg-white border border-transparent rounded-md focus:outline-none ">
                  ...
                  >
                      ...
                      <a href="#" class="flex items-center p-3 text-sm text-gray-600 capitalize  hover:bg-slate-100 transition">
                          <svg class="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
