<div>
  ...
  <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8" id="{{$headline}}">
    ...
    <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
      ...
      wire:navigate
      class="cursor-pointer flex max-w-xl flex-col items-start justify-between border border-slate-400 rounded-lg p-5 group hover:scale-110 hover:border-sky-800 hover:border-2 transition">
